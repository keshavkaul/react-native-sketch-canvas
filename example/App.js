...
import { AppRegistry, StyleSheet, Text, View, Alert, TouchableOpacity, ScrollView, Platform } from "react-native";
                    ...
                    <View style={{ flex: 1, flexDirection: "row" }}>
                        <RNSketchCanvas
                            ...
                            onClearPressed={() => {
                                ...
                                // this.canvas.scaleShapeById("samridh", 2.0);
                                // this.canvas.moveShapeById("samridh", { x: 30, y: 50 });
                                // this.canvas.rotateShapeById("samridh", -0.9961948990821838);
                            ...
                            strokeSelectedComponent={(color, index, changed) => {
                                return (
                                    <View
                                        style={[{ backgroundColor: color, borderWidth: 2 }, styles.strokeColorButton]}
                                    />
                                );
                            }}
                            ...
                            onShapeConfigChange={(e) => {
                                ...
                                console.log("onShapeConfig Change :::", e);
                            }}
                            shapeConfiguration={{
                    ...
                    <View style={{ flex: 1, flexDirection: "row" }}>
                        <View style={{ flex: 1, flexDirection: "column" }}>
                            ...
                            >
                                ...
                                <TouchableOpacity
                                    style={[styles.functionButton, { backgroundColor: "black", width: 90 }]}
                                    onPress={() => {

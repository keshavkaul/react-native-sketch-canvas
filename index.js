...
export default class RNSketchCanvas extends React.Component {
    ...
    deleteAllShapes() {
        this._sketchCanvas.deleteAllShapes();
    }
    ...
    scaleSelectedShape(value) {
        this._sketchCanvas.scaleSelectedShape(value);
    }

    rotateSelectedShape(value) {
        this._sketchCanvas.rotateSelectedShape(value);
    }

    moveShapeById(id, value) {
        this._sketchCanvas.moveShapeById(id, value);
    }

    scaleShapeById(id, value) {
        this._sketchCanvas.scaleShapeById(id, value);
    }

    rotateShapeById(id, value) {
        this._sketchCanvas.rotateShapeById(id, value);
    }
